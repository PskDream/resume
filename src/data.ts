...
//         details: [
//             "Designed Developed a web application for ordering cheque books using Angular, Spring Boot, and PostgreSQL.",
//             "Implemented a continuous integration and continuous deployment (CI/CD) pipeline for deploying applications.",
//             "Coordinated task planning, delegated responsibilities among team members, and reviewed code to ensure quality and consistency across the project."
//         ]
//     },
//     {
...
export const workExperiences = [
    ...
    },
    {
        ...
        years: ["Jan 2024", "May 2025"],
        details: [
            "Designed and maintained a hybrid cloud infrastructure integrating On-Premises (VMware) with AWS services (EC2, EKS, RDS, S3, etc.).",
            "Built and managed CI/CD pipelines for automated testing and deployment.",
            "Implemented centralized logging and performance monitoring systems using ELK Stack, Zabbix, and Grafana.",
            "Resolved a critical performance issue in a state enterprise tax invoice system by introducing caching mechanisms and optimizing I/O with SAS disks, improving system throughput by over 40%.",
            "Led sprint planning, delegated development tasks, and mentored junior developers to improve delivery efficiency and technical competency."
        ]
    },
    {
        position: "Full-stack Developer",
        ...
        years: ["Dec 2022", "Jan 2024"],
        details: [
            "Developed e-tax systems for generating XML and PDF/A documents.",
            "Built a host-to-host communication system for XML transmission to the Revenue Department via MPLS network.",
            "Implemented cryptographic features using Hardware Security Modules (HSMs) to support secure digital signing."
        ]
    },
    {
        position: "Internship Student",
        ...
        years: ["Jun 2022", "Dec 2022"],
        details: [
            "Developed core services for face detection, reporting, and public APIs using Django and Angular.",
            "Built a back-end concurrency service for document management and automated email delivery using Django and Celery.",
            "Developed tools and systems to support the migration of cloud infrastructure from Google Cloud Platform to AWS."
        ]
    }
]
